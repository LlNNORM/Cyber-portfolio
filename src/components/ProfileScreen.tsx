      ...
      >
        ...
        */}
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-8">
          ...
          <img 
            className="cyber-border rounded-lg w-full object-cover max-h-[600px] xl:max-h-none" 
            src={profileImg} 
            alt="Profile" 
          />
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {STATS_CONFIG.map((stat, index) => (
                <motion.div
                  key={stat.key}
                  className="cyber-border rounded bg-[#050508] p-3 sm:p-4 text-center"
          ...
          <img 
            className="cyber-border rounded-lg w-full object-cover hidden xl:block" 
            src={profileImg3} 
